...
const Contact = () => {
    ...
    const myPosition = [49.28644732341698, -122.78899966198036];
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_lunxfnb', 'template_mrfzbrp4', refForm.current, 'VJYzamB_WYcgzqaMW')
            .then(() => {
                setIsError(false);
    ...
    return (<>
        <div className='container contact-page'>
            <div className='text-zone'>
                ...
                <p>
                    I am interested in web development opportunities and will be happy to receive a message
                    from you.
